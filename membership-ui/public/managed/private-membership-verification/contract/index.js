...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      verifyMembership: (...args_1) => {
        ...
        const membershipSecret_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('verifyMembership',
                                     'argument 1 (as invoked from Typescript)',
                                     'private-membership-verification.compact line 30 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(membershipSecret_0),
  ...
  initialState(...args_0) {
    ...
    const initialGroupName_0 = args_0[1];
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue(0n),
                                                                                              alignment: _descriptor_8.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(initialGroupName_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
  ...
  _verifyMembership_0(context, partialProofData, membershipSecret_0) {
    const _privateSecret_0 = membershipSecret_0;
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
